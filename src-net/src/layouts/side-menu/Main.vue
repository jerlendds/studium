        ...
        <div class="flex">
            ...
            <nav class="side-nav">
                ...
                >
                    ...
                    />
                    <span class="hidden xl:block text-white text-2xl ml-3 font-semibold">
                        Studium
                    </span>
                </router-link>
                <!-- END: Logo -->
                ...
                <ul>
                    <li>
                        <button
                            class="flex bg-gray-50 w-full items-center justify-center py-1.5  text-lg  text-gray-800 font-medium rounded-3xl shadow"
